...
it('returns a list of mission ground suggestions', function () {
    // Setup
...
it('allows a user to record a mission ground suggestion', function () {
    // Setup
    Artisan::call('db:seed', ['--class' => 'DatabaseSeeder']);
...
it('allows a user to update a mission ground suggestion', function () {
    // Setup
    Artisan::call('db:seed', ['--class' => 'DatabaseSeeder']);
