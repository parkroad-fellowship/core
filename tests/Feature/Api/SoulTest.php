...
it('returns a list of souls', function () {
    // Setup
...
it('allows a user to record a soul who made a salvation commitment', function () {
    // Setup
    Artisan::call('db:seed', ['--class' => 'DatabaseSeeder']);
...
it('allows a user to update a soul who made a salvation commitment', function () {
    // Setup
    Artisan::call('db:seed', ['--class' => 'DatabaseSeeder']);
