...
it('allows a user to subscribe for a mission', function () {
    // Setup
    Artisan::call('db:seed', ['--class' => 'DatabaseSeeder']);
...
it('allows a user to update a mission subscription', function () {
    // Setup
    Artisan::call('db:seed', ['--class' => 'DatabaseSeeder']);
...
it('allows for the retrieval of mission subscriptions', function () {
    // Setup
    Artisan::call('db:seed', ['--class' => 'DatabaseSeeder']);
...
it('ensures start_time and end_time are formatted as time strings', function () {
    // Setup
    Artisan::call('db:seed', ['--class' => 'DatabaseSeeder']);
    $mission = Mission::factory()->create();
...
it('accepts manual time string assignments', function () {
    // Setup
    Artisan::call('db:seed', ['--class' => 'DatabaseSeeder']);
    $mission = Mission::factory()->create([
        'start_time' => '09:30',
