...
it('returns member engagement statistics', function () {
    // Setup
...
it('includes badges when requested', function () {
    // Setup
    Artisan::call('db:seed', ['--class' => 'DatabaseSeeder']);
...
it('includes comparative stats when requested', function () {
    // Setup
    Artisan::call('db:seed', ['--class' => 'DatabaseSeeder']);
...
it('filters engagement by year when provided', function () {
    // Setup
    Artisan::call('db:seed', ['--class' => 'DatabaseSeeder']);
...
// it('calculates mission stats correctly', function () {
//     // Setup
//     Artisan::call('db:seed', ['--class' => 'DatabaseSeeder']);
...
it('calculates impact stats with souls data', function () {
    // Setup
    Artisan::call('db:seed', ['--class' => 'DatabaseSeeder']);
