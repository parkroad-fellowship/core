...
it('allows a user to subscribe for a event', function () {
    // Setup
    Artisan::call('db:seed', ['--class' => 'DatabaseSeeder']);
...
it('allows a user to update an event subscription', function () {
    // Setup
    Artisan::call('db:seed', ['--class' => 'DatabaseSeeder']);
...
it('allows for the retrieval of event subscriptions', function () {
    // Setup
    Artisan::call('db:seed', ['--class' => 'DatabaseSeeder']);
...
it('deletes an event subscription', function () {
    // Setup
    Artisan::call('db:seed', ['--class' => 'DatabaseSeeder']);
    $event = PRFEvent::factory()->create([
        'status' => PRFActiveStatus::ACTIVE,
