...
it('returns a token when user is authenticated', function () {
    $password = 'password';

    $user = User::factory()->create([
        'password' => Hash::make($password),
    ]);
    $user->tenants()->syncWithoutDetaching([tenantId() => ['role' => 'member']]);
...
it('returns the user details when a user provides a valid authentication token', function () {
    $password = 'password';
...
it('logs out a user when they provide their token', function () {
    $password = 'password';
...
it('returns a user with requested relations', function () {
    initTenant();
...
it('returns an existing user with requested relations', function () {
    initTenant();
    Artisan::call('db:seed', ['--class' => 'DatabaseSeeder']);
    $password = 'password';
