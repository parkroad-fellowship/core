...
class AppSettingSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $settings = [
            ...
            [
                'group' => 'organization',
                'key' => 'organization.head_office_latitude',
                'value' => '-1.2906674',
                'type' => 'string',
            ],
            [
                'group' => 'organization',
                'key' => 'organization.head_office_longitude',
                'value' => '36.7690094',
                'type' => 'string',
            ],
            ...
            [
                'group' => 'desk_emails',
                'key' => 'desk_emails.missions',
                'value' => '["missions@example.org"]',
                'type' => 'array',
            ],
            [
                'group' => 'desk_emails',
                'key' => 'desk_emails.chairpersons',
                'value' => '["chairperson@example.org"]',
                'type' => 'array',
            ],
            [
                'group' => 'desk_emails',
                'key' => 'desk_emails.treasurers',
                'value' => '["treasurer@example.org"]',
                'type' => 'array',
            ],
            [
                'group' => 'desk_emails',
                'key' => 'desk_emails.prayer',
                'value' => '["prayer@example.org"]',
                'type' => 'array',
            ],
            [
                'group' => 'desk_emails',
                'key' => 'desk_emails.follow_up',
                'value' => '["followup@example.org"]',
                'type' => 'array',
            ],
            [
                'group' => 'desk_emails',
                'key' => 'desk_emails.music',
                'value' => '["music@example.org"]',
                'type' => 'array',
            ],
            [
                'group' => 'desk_emails',
                'key' => 'desk_emails.organising_secretary',
                'value' => '["secretary@example.org"]',
                'type' => 'array',
            ],
            [
                'group' => 'desk_emails',
                'key' => 'desk_emails.vice_chairpersons',
                'value' => '["vicechair@example.org"]',
                'type' => 'array',
            ],
            ...
            [
                'group' => 'general',
                'key' => 'general.executive_committee_roles',
                'value' => json_encode([
                    'chairperson',
                    'vice chairperson',
