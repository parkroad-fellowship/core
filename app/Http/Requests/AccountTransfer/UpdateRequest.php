...
class UpdateRequest extends FormRequest
{
    ...
    {
        return $this->user()?->can(AccountTransfer::permission('edit')) ?? false;
    }
    ...
    {
        return [
            'from_financial_account_ulid' => ['sometimes', 'required', 'string', 'exists:financial_accounts,ulid'],
            ...
            'transferred_on' => ['sometimes', 'required', 'date', 'before_or_equal:today'],
