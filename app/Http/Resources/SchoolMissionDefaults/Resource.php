...
namespace App\Http\Resources\SchoolMissionDefaults;
    ...
    public function toArray(Request $request): array
    {
        $types = collect($this->mission_defaults['types'] ?? [])
            ->map(fn(array $defaults, string $missionTypeId) => [
                'mission_type' => new \App\Http\Resources\MissionType\Resource($this->missionTypes->get(
                    (int) $missionTypeId,
                )),
        ...
        return [
            'entity' => 'school-mission-defaults',

            'school_ulid' => $this->ulid,

            'default_mission_type' => new \App\Http\Resources\MissionType\Resource($this->missionTypes->get(
