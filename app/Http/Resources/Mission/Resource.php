...
class Resource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'status' => $this->resource instanceof \App\Models\Mission ? $this->resource->status->enum()->value : null,
            'status_reason' => $this->resource instanceof \App\Models\Mission ? $this->resource->status_reason : null,
            'theme' => $this->theme,
