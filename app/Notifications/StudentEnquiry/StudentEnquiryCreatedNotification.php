...
/**
 * Not sent yet: via() returns no channels until enquiry push notifications are switched on.
 * To enable, return the channels in via() and add a listener on StudentEnquiryCreated that
 * sends it to the members who answer enquiries.
 */
class StudentEnquiryCreatedNotification extends BaseNotification implements HasTargetApp
{
