...
class MissionWhatsAppGroupLinkedNotification extends BaseNotification implements HasTargetApp
{
    ...
    public function toFcm($notifiable)
    {
        ...
        return new FcmMessage(notification: new FcmNotification(title: $title, body: $body))->data([
            'type' => PRFNotificationType::MISSION_WHATSAPP_GROUP_LINKED->value,
