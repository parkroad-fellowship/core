...
class ThankYouNotification extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ...
            ->line('')
            ->line('**Community Change:** Thanks to volunteers like you, we are able to create positive change and build stronger educational foundations in our communities.')
            ->line('')
