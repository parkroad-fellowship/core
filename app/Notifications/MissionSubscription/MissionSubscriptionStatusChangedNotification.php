...
class MissionSubscriptionStatusChangedNotification extends BaseNotification implements HasTargetApp
{
    ...
    public function toFcm($notifiable)
    {
        ...
        return new FcmMessage(notification: new FcmNotification(title: $title, body: $body))->data([
            'type' => PRFNotificationType::MISSION_SUBSCRIPTION_STATUS_CHANGED->value,
