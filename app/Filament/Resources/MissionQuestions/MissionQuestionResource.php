    ...
    public static function form(Schema $schema): Schema
    {
        return $schema->components([
            Section::make('Mission Information')
                ->columnSpanFull()
                ->description(
                    'Link this question to the mission where it was asked. This helps track questions by location and event.',
                )
            ...
            Section::make('Question Details')
                ->columnSpanFull()
                ->description(
                    'Record the question exactly as it was asked during the mission. This information is valuable for training and FAQ development.',
                )
