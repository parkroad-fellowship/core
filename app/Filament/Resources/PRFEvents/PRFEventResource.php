    ...
    public static function form(Schema $schema): Schema
    {
        return $schema->components([
            ...
            Section::make('Event Details')
                ->columnSpanFull()
                ->description(
                    'Enter the basic information about your event. This helps attendees understand what the event is about.',
                )
            ...
            Section::make('Notification Recipients')
                ...
                ->schema([
                    Repeater::make('eventHandlers')
                        ...
                        ->helperText(
                            'Add members who should receive an email or notification when someone registers for this event. You can add multiple people.',
                        )
                        ->relationship()
                        ->schema([
                        ...
                        ->deleteAction(
                            fn(Action $action) => $action
                                ...
                                ->modalDescription(
                                    'Are you sure you want to remove this person from the notification list? They will no longer receive registration alerts.',
                                ),
                        )
                        ->columnSpanFull(),
                ]),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                TextColumn::make('start_time')->label('Start Time')->time('g:i A')->timezone(Auth::user()->timezone),
                ...
                ActionGroup::make([
                    ...
                    Action::make('toggle_status')
                        ...
                        ->action(function ($record) {
                            $record->update([
                                'status' => $record->status === PRFActiveStatus::ACTIVE
