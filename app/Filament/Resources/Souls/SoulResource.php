    ...
    public static function form(Schema $schema): Schema
    {
        return $schema->components([
            Section::make('Student Information')
                ->columnSpanFull()
                ->description(
                    'Record details of students who made decisions during missions. This information helps with follow-up and discipleship.',
                )
                    ...
                    Grid::make(2)
                        ...
                        ->schema([
                            ...
                            TextInput::make('admission_number')
                                ...
                                ->helperText(
                                    'The student\'s school admission or registration number. This helps identify them within their institution.',
                                )
                                ->maxLength(255)
            ...
            Section::make('Class & Decision Details')
                ->columnSpanFull()
                ->description(
                    'Specify which class the student belongs to and the type of spiritual decision they made.',
                )
            ...
            Section::make('Additional Notes')
                ...
                ->schema([
                    ContentSchema::notesField(
                        ...
                        'Record any additional observations, prayer requests, or follow-up needs for this student.',
                    ),
                ])
                ->collapsible(),
        ]);
            ...
            ->filters([
                ...
                Filter::make('mission_date')
                    ...
                    ->query(function (Builder $query, array $data): Builder {
                        return $query->when($data['from'], fn(
                            Builder $query,
                            $date,
                        ): Builder => $query->whereHas('mission', fn($query) => $query->whereDate(
                            'start_date',
                            '>=',
                            $date,
                        )))->when($data['until'], fn(
