        ...
        return $table
            ->columns([
                ...
                IconColumn::make('official_whatsapp_link')
                    ...
                    ->tooltip(fn($record) => $record->official_whatsapp_link
                        ? 'WhatsApp group link is available'
                        : 'No WhatsApp link configured'),
            ...
            ->filters([
                TrashedFilter::make()->native(false)->label('Show Deleted Groups'),
            ...
            ->recordActions([
                ...
                Action::make('toggle_status')
                    ->label(fn(Group $record) => $record->is_active === PRFActiveStatus::ACTIVE
                        ? 'Deactivate'
                        : 'Activate')
                    ->icon(fn(Group $record) => $record->is_active === PRFActiveStatus::ACTIVE
                        ? 'heroicon-o-pause-circle'
