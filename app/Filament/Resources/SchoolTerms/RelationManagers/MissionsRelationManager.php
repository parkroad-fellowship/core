        ...
        return $table
            ...
            ->filters([
                ...
                Filter::make('current_month')
                    ->label('This Month')
                    ->query(fn(Builder $query) => $query->whereMonth('start_date', now()->month)->whereYear(
                        'start_date',
                        now()->year,
                    ))
    ...
    public function infolist(Schema $schema): Schema
    {
        return $schema->components([
            Section::make('Mission Overview')
                ...
                ->schema([
                    TextEntry::make('school.name')->label('School')->color(Color::Blue)->weight(FontWeight::SemiBold),
