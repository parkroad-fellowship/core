    ...
    public static function form(Schema $schema): Schema
    {
        return $schema->components([
            Section::make('Member Information')
                ->columnSpanFull()
                ->description(
                    'Select the member who is registering and the spiritual year for this membership. Each member can have one membership per spiritual year.',
                )
            ...
            Section::make('Membership Details')
                ->columnSpanFull()
                ->description(
                    'Specify the membership type and payment amount. Different membership types have different benefits and durations.',
                )
                    ...
                    Grid::make(2)
                        ...
                        ->schema([
                            ...
                            TextInput::make('amount')
                                ...
                                ->prefix('KES ')
                                ->helperText(
                                    'Enter the membership fee amount paid by the member. This should match the membership type rate.',
                                )
            ...
            Section::make('Approval Status')
                ->columnSpanFull()
                ->description(
                    'Control whether this membership is approved and active. Only approved memberships grant member benefits.',
                )
                ...
                ->schema([
                    Toggle::make('approved')
                        ->label('Approved')
                        ->helperText(
                            'Toggle to approve or reject this membership. Approved members receive full membership benefits and access.',
                        )
                        ->default(false),
                ])
                ->collapsible(),
