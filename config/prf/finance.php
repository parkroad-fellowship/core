...
return [
    ...
    'import' => [
        ...
        // Workbook desk/category label (normalised: lowercase, trimmed, single spaces, ' unified)
        // → ledger category code. Receipts hitting an expense.desk.* code are booked to that
        // desk's refund.desk.* category instead (the workbook books refunds under the desk).
        'category_map' => [
            // Income.
            'member contribution' => 'income.member_contribution',
            'mission contribution' => 'income.mission_contribution',
            'appreciation from schools' => 'income.appreciation_from_schools',
            'camp contribution' => 'income.camp_contribution',
            'member subscription' => 'income.member_subscription',
            'prf membership subscription' => 'income.member_subscription',
            'tithe & offering' => 'income.tithe_and_offering',
            'tithe' => 'income.tithe_and_offering',
            'offering' => 'income.tithe_and_offering',
            'interest on fixed deposit' => 'income.interest',
            'gik - rent & instruments' => 'income.gik',
            'other receipts' => 'income.other',
            // Expense: desks.
            'mission desk' => 'expense.desk.4',
            'mission expenses' => 'expense.desk.4',
            'prayer desk' => 'expense.desk.5',
            'prayer desk expenses' => 'expense.desk.5',
            "chairman's desk" => 'expense.desk.1',
            "chairman's desk expenses" => 'expense.desk.1',
            "organizing secretary's desk" => 'expense.desk.3',
            "organizing secretary's expenses" => 'expense.desk.3',
            "treasurer's desk" => 'expense.desk.8',
            "treasurer's desk expenses" => 'expense.desk.8',
            'music desk' => 'expense.desk.7',
            'music desk expenses' => 'expense.desk.7',
            'follow-up desk' => 'expense.desk.6',
            'follow-up desk expenses' => 'expense.desk.6',
            "vice chairman's epenses" => 'expense.desk.2',
            "vice chairman's desk" => 'expense.desk.2',
            // Expense: other lines.
            'bot expenses - strategic plan' => 'expense.bot',
            'bot expenses' => 'expense.bot',
            'camp expense' => 'expense.camp',
            'camp expenses' => 'expense.camp',
            'agm expense' => 'expense.agm',
            'agm expenses' => 'expense.agm',
            'dinner expense' => 'expense.dinner',
            'dinner expenses' => 'expense.dinner',
            'other expenses' => 'expense.other',
            // Refund.
            'mission refund' => 'refund.desk.4',
            'prayer desk refund' => 'refund.desk.5',
            'os refund' => 'refund.desk.3',
            'chairman refund' => 'refund.desk.1',
            'treasurer refund' => 'refund.desk.8',
            'music desk refund' => 'refund.desk.7',
            'follow-up desk refund' => 'refund.desk.6',
            'vice chairman refund' => 'refund.desk.2',
        ],
    ],
];
